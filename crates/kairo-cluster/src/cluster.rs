...
use kairo_core::actor::actor_system::{ActorSystem, WeakActorSystem};
use kairo_core::actor::address::Address;
use kairo_core::actor::extension::Extension;
...
use kairo_core::pattern::patterns::PatternsExt;
use kairo_core::provider::{TActorRefProvider, downcast_provider};
...
impl Cluster {
    pub fn new(system: ActorSystem) -> anyhow::Result<Self> {
        ...
        let etcd_actor_props =
            Props::new_with_ctx(move |context| Ok(EtcdActor::new(context, client)));
