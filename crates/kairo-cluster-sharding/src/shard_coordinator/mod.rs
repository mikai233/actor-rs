...
use kairo_cluster::cluster::Cluster;
use kairo_cluster::etcd_actor::keep_alive::KeepAlive;
use kairo_cluster::etcd_client::PutOptions;
use kairo_core::actor::context::{ActorContext, Context};
use kairo_core::actor::props::Props;
use kairo_core::actor::timers::{ScheduleKey, Timers};
use kairo_core::actor_path::TActorPath;
use kairo_core::actor_ref::actor_ref_factory::ActorRefFactory;
use kairo_core::actor_ref::{ActorRef, ActorRefExt, PROVIDER};
use kairo_core::ext::{decode_bytes, encode_bytes};
use kairo_core::{Actor, CodecMessage, DynMessage};
...
impl ShardCoordinator {
    ...
    async fn region_terminated(&mut self, context: &mut ActorContext, region: ActorRef) {
