...
impl ClusterSingletonProxy {
    fn new(context: &mut Context, singleton_mgr_path: String, settings: ClusterSingletonProxySettings) -> Self {
    ...
    fn buffer_message(&mut self, context: &mut Context, message: DynMessage) {
    ...
    fn identify_singleton(&mut self, context: &mut Context) {
