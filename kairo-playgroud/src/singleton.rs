...
use kairo_cluster_tools::singleton::cluster_singleton_manager::{
    ClusterSingletonManager, ClusterSingletonManagerSettings,
};
use kairo_cluster_tools::singleton::cluster_singleton_proxy::ClusterSingletonProxy;
use kairo_cluster_tools::singleton::cluster_singleton_proxy::cluster_singleton_proxy_settings::ClusterSingletonProxySettings;
use kairo_core::DynMessage;
use kairo_core::actor::actor_system::ActorSystem;
use kairo_core::actor::props::PropsBuilder;
...
use kairo_playgroud::common::build_cluster_setting;
use kairo_playgroud::common::greet::Greet;
use kairo_playgroud::common::singleton_actor::SingletonActor;
use kairo_playgroud::common::stop_singleton::StopSingleton;
...
async fn main() -> anyhow::Result<()> {
    ...
    init_logger_with_filter("actor=debug,kairo-core::scheduler=info");
